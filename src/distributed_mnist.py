...
parser.add_argument("--model_dir", type=str, default="/workspace/saved_models/")
...
train_dataset=datasets.MNIST(root='/workspace/data', train=True, download=True,
...
for epoch in range(1, args.epochs + 1):
    ...
    if (args.epochs - epoch) % 10 == 0:
        torch.save(model.state_dict(), args.model_dir + "{}.pt".format(epoch))
